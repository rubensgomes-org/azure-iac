...
module "monitoring" {
  ...
  # Email receiver for the `owner` alert channel. Supplied as
  # TF_VAR_action_group_email — see variables.tf on why it lives neither in
  # ../../envs/<env>/env.tfvars nor in a terraform.tfvars here.
