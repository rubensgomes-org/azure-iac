# roots/12-monitoring/providers.tf
# -----------------------------------------------------------------------------
# Provider configuration for the monitoring root config.
#
...
# docs/INITIAL_SETUP.md for the one-time SP setup that produces those
# values.
#
