...
output "kv_name" {
  description = "Key Vault name (`kv-<workload>-<env>`). Deterministic, so a rebuild inside the soft-delete window needs `az keyvault purge` first."
