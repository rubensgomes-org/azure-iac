...
What each of the twelve module roots under `terraform/roots/` needs applied
...
- **09 does not depend on 02.** The `pg` subnet exists but is unused — PG runs
  in public-access mode. The delegated-subnet destroy hazard is 10/11 vs 02.
